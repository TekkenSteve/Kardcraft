...
import (
	...
	v1dto "task-orchestrator/internal/controller/restapi/v1/dto"
...
func (p *UsageProjector) Project(ctx context.Context, ev v1dto.NormalizedEvent) {
...
func BuildUsageLedgerRow(payload map[string]any, workflowID, fallbackTaskID, fallbackSessionID string) (usecase.UsageLedgerRow, bool, string) {
	...
	row := usecase.UsageLedgerRow{
		...
		ExternalRequestID: normalizedString(firstAny(usagePayload.ExternalRequest), ""),
