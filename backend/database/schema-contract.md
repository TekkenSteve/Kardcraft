...
- `kc_task_template_bindings`: task-template binding truth
...
The following tables are deprecated and excluded from active write paths:
...
Their removal is staged and handled only by future migrations.
