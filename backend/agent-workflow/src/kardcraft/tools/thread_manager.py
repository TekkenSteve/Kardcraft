...
from kardcraft.services.llm import make_llm_api_call, LLMError
from kardcraft.tools.prompt_caching import apply_anthropic_caching_strategy, validate_cache_blocks
from kardcraft.tools.tool import Tool
from kardcraft.tools.tool_registry import ToolRegistry
from kardcraft.tools.context_manager import ContextManager
from kardcraft.tools.response_processor import ResponseProcessor, ProcessorConfig
from kardcraft.tools.error_processor import ErrorProcessor
from kardcraft.services.supabase import DBConnection
from kardcraft.utils.logger import logger
from langfuse.client import StatefulGenerationClient, StatefulTraceClient
from kardcraft.services.langfuse import langfuse
    ...
    async def _execute_run(
        ...
        try:
            ...
            if ENABLE_PROMPT_CACHING:
                try:
                    from kardcraft.models import model_manager
                    from litellm.utils import token_counter
                    client = await self.db.client
